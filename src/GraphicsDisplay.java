...
//                System.out.`println(Arrays.toString(point));
            ...
            Line2D.Double horizontalLine1 = new Line2D.Double();
            horizontalLine1.setLine(
                    constructPoint(xyToPoint(point[0], point[1]), -5, -5),
                    constructPoint(xyToPoint(point[0], point[1]), 5, -5)
            );
            Line2D.Double diagonalLine1 = new Line2D.Double();
            diagonalLine1.setLine(
                    constructPoint(xyToPoint(point[0], point[1]), -5, -5),
                    constructPoint(xyToPoint(point[0], point[1]), 5, 5)
            );
            Line2D.Double verticalLine2 = new Line2D.Double();
            verticalLine2.setLine(
                    constructPoint(xyToPoint(point[0], point[1]), 5, -5),
                    constructPoint(xyToPoint(point[0], point[1]), 5, 5)
            );
            Line2D.Double horizontalLine2 = new Line2D.Double();
            horizontalLine2.setLine(
                    constructPoint(xyToPoint(point[0], point[1]), -5, 5),
                    constructPoint(xyToPoint(point[0], point[1]), 5, 5)
            );
            Line2D.Double diagonalLine2 = new Line2D.Double();
            diagonalLine2.setLine(
                    constructPoint(xyToPoint(point[0], point[1]), 5, -5),
                    constructPoint(xyToPoint(point[0], point[1]), -5, 5)
            );
            ...
            canvas.draw(horizontalLine1);
            canvas.draw(diagonalLine1);
            canvas.draw(verticalLine2);
            canvas.draw(horizontalLine2);
            canvas.draw(diagonalLine2);
        }
    }

    private boolean isAscending(double[] point) {
        return Math.abs(point[1] - Math.round(point[1])) <= 0.1;
    }
    ...
    private void paintGrid(Graphics2D canvas) {
        ...
        double divisionIncrement = (this.viewport[1][1] - this.viewport[0][1]) / 100.0;

        for (int i = 0; i <= 100; i++) {
            double length = (i % 5 == 0) ? 0.02 : 0.01;

            if (!isRotated) {
                canvas.draw(new Line2D.Double(
                        xyToPoint(this.viewport[0][0], this.viewport[1][1] - i * divisionIncrement),
                        xyToPoint(this.viewport[0][0] + length, this.viewport[1][1] - i * divisionIncrement)
                ));
            }
        }
    }
